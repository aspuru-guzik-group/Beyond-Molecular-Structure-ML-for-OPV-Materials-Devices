...
### EXAMPLE USE
"""
python ../../cross_test.py --dataset_path ~/Research/Repos/_ml_for_opvs/_ml_for_opvs/data/input_representation/OPV_Min/aug_SMILES/train_aug_master5.csv --num_of_folds 5 --type_of_crossval KFold
"""
