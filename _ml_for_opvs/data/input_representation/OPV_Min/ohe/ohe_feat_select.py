...
OHE_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs",
    "data/input_representation/OPV_Min/ohe/master_ohe.csv",
)

DATA_PATH = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/ohe/"
)
...
molecules = {"Donor", "Acceptor", "DA_ohe"}
...
class FeatureSelection:
    ...
    def feat_select(self, feat_list):
        ...
        df.to_csv(DATA_PATH + "processed_ohe_{x}.csv".format(x=feat_list), index=False)


fs = FeatureSelection(OHE_DATA)
