...
MASTER_MORDRED_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/mordred/master_mordred.csv"
)

DATA_PATH = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/mordred/"
)
...
class FeatureSelection:
    ...
    def feat_select(self, feat_list):
        ...
        df.to_csv(
            DATA_PATH + "processed_mordred_{x}.csv".format(x=feat_list), index=False
        )


fs = FeatureSelection(MASTER_MORDRED_DATA)
