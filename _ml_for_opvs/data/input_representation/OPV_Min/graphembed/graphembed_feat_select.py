...
MASTER_GRAPH_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/graphembed/master_graphembed.csv"
)

DATA_PATH = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/graphembed/"
)
...
class FeatureSelection:
    ...
    def feat_select(self, feat_list):
        ...
        df.to_csv(
            DATA_PATH + "processed_graphembed_{x}.csv".format(x=feat_list), index=False
        )


fs = FeatureSelection(MASTER_GRAPH_DATA)
