...
MASTER_MORDRED_PCA_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs",
    "data/input_representation/OPV_Min/mordred_pca/master_mordred_pca.csv",
)

DATA_PATH = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/mordred_pca/"
)
...
fs = FeatureSelection(MASTER_MORDRED_PCA_DATA)
