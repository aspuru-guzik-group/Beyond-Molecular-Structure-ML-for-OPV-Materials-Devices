...
IMAGE_PATH = pkg_resources.resource_filename("_ml_for_opvs", "data/input_representation/")

CLEAN_DONOR_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/preprocess/clean_min_donors.csv"
)

CLEAN_ACCEPTOR_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/preprocess/clean_min_acceptors.csv"
)

NUM_FRAG_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/num_of_frag.csv"
)
