...
IMAGE_PATH = pkg_resources.resource_filename("_ml_for_opvs", "data/input_representation/OPV_Min/")

FRAG_MASTER_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/frag_master_ml_for_opvs_from_min.csv"
)

NUM_FRAG_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/num_of_frag.csv"
)

TRAIN_MASTER_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/train_frag_master.csv"
)
