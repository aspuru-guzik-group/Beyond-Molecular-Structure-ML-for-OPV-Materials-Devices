...
IMG_PATH = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/manual_frag/"
)

FRAG_DONOR_DIR = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/manual_frag/donor_frags.csv"
)

FRAG_ACCEPTOR_DIR = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/manual_frag/acceptor_frags.csv"
)
...
class manual_frag:
    ...
    def fragment_new(self, frag_path, master_path, mol_type):
        ...
        if all_fragmented:
            print("All molecules have already been fragmented. Please add new molecules.")
...
def fragment_files(molecule_type:str):
    ...
    # For Donors
    if molecule_type == "donor":
        manual.fragment_new(FRAG_DONOR_DIR, MASTER_ML_DATA, molecule_type)
    # For Acceptors
    elif molecule_type == "acceptor":
        manual.fragment_new(FRAG_ACCEPTOR_DIR, MASTER_ML_DATA, molecule_type)
