...
DATA_PATH = pkg_resources.resource_filename("_ml_for_opvs", "data/input_representation/OPV_Min/manual_frag/")
...
class FeatureSelection:
    ...
    def feat_select(self, feat_list):
        ...
        df.to_csv(DATA_PATH + 'processed_manual_frag_{x}.csv'.format(x = feat_list), index = False)
