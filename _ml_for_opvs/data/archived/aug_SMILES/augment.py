...
from _ml_for_opvs.ML_models.sklearn.tokenizer import Tokenizer
...
AUGMENT_SMILES_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/aug_SMILES/train_aug_master.csv")

# AUGMENT_SMILES_DATA = pkg_resources.resource_filename(
#     "_ml_for_opvs", "data/input_representation/OPV_Min/aug_SMILES/train_aug_master.parquet")
