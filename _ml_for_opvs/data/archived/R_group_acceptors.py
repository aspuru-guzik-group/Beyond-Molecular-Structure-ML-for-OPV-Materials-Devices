...
ACC_PATH = pkg_resources.resource_filename("_ml_for_opvs", "min_acceptors_smiles.txt")
CSV_PATH = pkg_resources.resource_filename("_ml_for_opvs", "min_acceptors_smiles.csv")
