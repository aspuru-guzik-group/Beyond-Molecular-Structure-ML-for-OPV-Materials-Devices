...
MASTER_ML_DATA_PLOT = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/preprocess/OPV_Min/master_ml_for_opvs_from_min_for_plotting.csv"
)

HOMO_D_DISTRIBUTION = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/homo_donor_distribution_plot.png"
)

LUMO_D_DISTRIBUTION = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/lumo_donor_distribution_plot.png"
)

HOMO_A_DISTRIBUTION = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/homo_acceptor_distribution_plot.png"
)

LUMO_A_DISTRIBUTION = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/lumo_acceptor_distribution_plot.png"
)

HOMO_D_DISTRIBUTION_APPROX = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/homo_approx_donor_distribution_plot.png"
)

LUMO_D_DISTRIBUTION_APPROX = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/lumo_approx_donor_distribution_plot.png"
)

HOMO_A_DISTRIBUTION_APPROX = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/homo_approx_acceptor_distribution_plot.png"
)

LUMO_A_DISTRIBUTION_APPROX = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/lumo_approx_acceptor_distribution_plot.png"
)

STATS_D_HOMO = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/stats_homo_donor.csv"
)

STATS_D_LUMO = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/stats_lumo_donor.csv"
)

STATS_A_HOMO = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/stats_homo_acceptor.csv"
)

STATS_A_LUMO = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/stats_lumo_acceptor.csv"
)
