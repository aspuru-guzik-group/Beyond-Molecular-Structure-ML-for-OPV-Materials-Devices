...
DUPLICATE_DONORS = pkg_resources.resource_filename("_ml_for_opvs", "data/preprocess/OPV_Min/duplicate labels - donors.csv")

DUPLICATE_ACCEPTORS = pkg_resources.resource_filename("_ml_for_opvs", "data/preprocess/OPV_Min/duplicate labels - acceptors.csv")
