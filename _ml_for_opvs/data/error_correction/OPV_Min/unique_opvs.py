...
MISSING_SMI_DONOR = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/missing_smi_donors.csv"
)
MISSING_SMI_ACCEPTOR = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/missing_smi_acceptors.csv"
)
...
COMPARE_PATH = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/error_correction/OPV_Min/compare_sheets_chemdraw.csv"
)
