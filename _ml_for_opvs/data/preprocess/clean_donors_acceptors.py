...
OPV_DONOR_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/raw/OPV_Min/Machine Learning OPV Parameters - Donors.csv"
)
...
MISSING_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/preprocess/OPV_Min/missing_pairs.csv"
)

UNIQUE_DONOR = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/preprocess/OPV_Min/unique_donors.csv"
)

UNIQUE_ACCEPTOR = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/preprocess/OPV_Min/unique_acceptors.csv"
)
...
INTERLAYER_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/raw/OPV_Min/interlayer_properties.csv"
)

MASTER_OHE_DATA = pkg_resources.resource_filename(
    "_ml_for_opvs", "data/input_representation/OPV_Min/ohe/master_ohe.csv"
)
