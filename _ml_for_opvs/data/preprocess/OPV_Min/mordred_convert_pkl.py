...
GRAPH_PKL = pkg_resources.resource_filename("_ml_for_opvs", f"../_gary/trained_results")

MORDRED_PKL = pkg_resources.resource_filename(
    "_ml_for_opvs", "../_gary/data/min_mordred.pkl"
)

PCA_MORDRED_PKL = pkg_resources.resource_filename(
    "_ml_for_opvs", "../_gary/data/min_pca_mordred.pkl"
)
