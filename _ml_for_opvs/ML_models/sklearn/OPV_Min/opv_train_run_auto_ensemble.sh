...
# 2
feat_select_group=("molecules_only" "fabrication_wo_solid" "device_wo_thickness") # "fabrication_wo_solid" "device_wo_thickness"
...
#7
multi_output_type=("ensemble") # "ensemble" or "multi"
