...
#!/bin/bash
#SBATCH --time=6:00:00
#SBATCH --output=/project/6033559/stanlo/_ml_for_opvs/_ml_for_opvs/ML_models/pytorch/OPV_Min/slurm.out
#SBATCH --error=/project/6033559/stanlo/_ml_for_opvs/_ml_for_opvs/ML_models/pytorch/OPV_Min/slurm.err
