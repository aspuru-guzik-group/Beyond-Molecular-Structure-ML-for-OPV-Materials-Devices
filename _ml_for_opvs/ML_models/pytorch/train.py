...
from _ml_for_opvs.ML_models.pytorch.LSTM.lstm_regression import LSTMModel
from _ml_for_opvs.ML_models.pytorch.pipeline import (
    process_features,
    process_features_LM,
    process_target,
)

from _ml_for_opvs.ML_models.pytorch.NN.nn_regression import NNModel
...
# python ../train.py --train_path ~/Research/Repos/_ml_for_opvs/_ml_for_opvs/data/input_representation/CO2_Soleimani/BRICS/StratifiedKFold/input_train_0.csv --test_path ~/Research/Repos/_ml_for_opvs/_ml_for_opvs/data/input_representation/CO2_Soleimani/BRICS/StratifiedKFold/input_test_0.csv --feature_names Polymer_BRICS,T_K,P_Mpa --target_name exp_CO2_sol_g_g --model_type NN --model_config ../NN/model_config.json --results_path ~/Research/Repos/_ml_for_opvs/_ml_for_opvs/training/CO2_Soleimani/BRICS
