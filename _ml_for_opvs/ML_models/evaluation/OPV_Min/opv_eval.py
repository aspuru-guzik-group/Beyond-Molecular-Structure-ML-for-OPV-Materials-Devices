...
from _ml_for_opvs.ML_models.pytorch.data.OPV_Min.tokenizer import Tokenizer
from _ml_for_opvs.ML_models.pytorch.NN.OPV_Min.opv_NN import NNModel
from _ml_for_opvs.ML_models.pytorch.LSTM.OPV_Min.opv_LSTM import LSTMModel

from _ml_for_opvs.ML_models.pytorch.data.OPV_Min.data import OPVDataModule
...
MODEL_CHECKPOINT = pkg_resources.resource_filename(
    "_ml_for_opvs", "model_checkpoints/OPV_Min"
)

CHEMBERT_TOKENIZER = pkg_resources.resource_filename(
    "_ml_for_opvs", "ML_models/pytorch/Transformer/tokenizer_chembert/"
)

CHEMBERT = pkg_resources.resource_filename(
    "_ml_for_opvs", "ML_models/pytorch/Transformer/chembert/"
)
