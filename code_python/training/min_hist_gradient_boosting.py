...
from code_python.training import unroll_lists_to_columns, unroll_solvent_descriptors
...
with open(DATASETS / "Min_2020_n558" / "subsets.json", "r") as f:
    subsets: dict[str, list[str]] = json.load(f)

with open("../pipeline/seeds.json", "r") as f:
