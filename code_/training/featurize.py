...
# from _ml_for_opvs.graphs import get_onehot_encoder, from_smiles
...
if __name__ == "__main__":
    ...
    assert FLAGS.dataset in [
        "min",
        "min_fab_nosolid",
    ], "Invalid dataset flag. Pick `min`, `min_fab_nosolid`"
    assert FLAGS.feature in [
        "fp",
        "mordred",
        "pca_mordred",
        "graph",
