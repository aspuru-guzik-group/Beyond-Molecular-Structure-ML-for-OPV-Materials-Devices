...
regressor_search_space: dict[str, dict] = {
    ...
    "KRR":   {"regressor__alpha":  Real(1e-3, 1e3, prior="log-uniform"),
              "regressor__kernel": Categorical(["rbf", tanimoto_distance]),
    ...
    # "GP":  {"regressor__kernel": Categorical([tanimoto_distance]),
    #         "regressor__n_restarts_optimizer": Integer(0, 5),
    #         "regressor__normalize_y":         [True],
    #         },
    "NN":    {"regressor__n_layers":       Integer(1, 20),
              "regressor__n_neurons":      Integer(1, 100),
              ...
              # "regressor__learning_rate_init": Real(1e-4, 1e-2, prior="log-uniform"),
              # "regressor__max_iter":           Integer(50, 500),
