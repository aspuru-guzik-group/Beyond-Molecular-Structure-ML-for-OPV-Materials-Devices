...
none = ['Unnamed: 0', 'Donor', 'Acceptor', 'PCE (%)', 'calc_PCE (%)', 'Voc (V)', 'Jsc (mA cm^-2)', 'FF (%)', 'DA_manual_tokenized', 'DA_manual_tokenized_aug']
electronic = ['Unnamed: 0', 'Donor', 'Acceptor', 'HOMO_D (eV)', 'LUMO_D (eV)', 'HOMO_A (eV)', 'LUMO_A (eV)', 'PCE (%)', 'calc_PCE (%)', 'Voc (V)', 'Jsc (mA cm^-2)', 'FF (%)', 'DA_manual_tokenized', 'DA_manual_tokenized_aug']
electronic_only = ['Unnamed: 0', 'HOMO_D (eV)', 'LUMO_D (eV)', 'HOMO_A (eV)', 'LUMO_A (eV)', 'PCE (%)', 'calc_PCE (%)', 'Voc (V)', 'Jsc (mA cm^-2)', 'FF (%)']
device = ['Unnamed: 0', 'Donor', 'Acceptor', 'D:A ratio (m/m)', 'solvent', 'total solids conc. (mg/mL)', 'solvent additive', 'solvent additive conc. (%v/v)', 'active layer thickness (nm)', 'annealing temperature', 'hole contact layer', 'electron contact layer', 'hole mobility blend (cm^2 V^-1 s^-1)', 'electron mobility blend (cm^2 V^-1 s^-1)', 'PCE (%)', 'calc_PCE (%)', 'Voc (V)', 'Jsc (mA cm^-2)', 'FF (%)', 'DA_manual_tokenized', 'DA_manual_tokenized_aug']
device_solvent = ['Unnamed: 0', 'Donor', 'Acceptor', 'D:A ratio (m/m)', 'total solids conc. (mg/mL)', 'solvent additive', 'solvent additive conc. (%v/v)', 'active layer thickness (nm)', 'annealing temperature', 'hole contact layer', 'electron contact layer', 'hole mobility blend (cm^2 V^-1 s^-1)', 'electron mobility blend (cm^2 V^-1 s^-1)', 'PCE (%)', 'calc_PCE (%)', 'Voc (V)', 'Jsc (mA cm^-2)', 'FF (%)', 'BP', 'MP', 'Density', 'Dielectric', 'Dipole', 'log Pow', 'Hansen Disp', 'Hansen H-Bond', 'Hansen Polar', 'DA_manual_tokenized', 'DA_manual_tokenized_aug']
fabrication = ['Unnamed: 0', 'Donor', 'Acceptor', 'D:A ratio (m/m)', 'solvent', 'total solids conc. (mg/mL)', 'solvent additive', 'solvent additive conc. (%v/v)', 'active layer thickness (nm)', 'annealing temperature', 'PCE (%)', 'calc_PCE (%)', 'Voc (V)', 'Jsc (mA cm^-2)', 'FF (%)', 'DA_manual_tokenized', 'DA_manual_tokenized_aug']
