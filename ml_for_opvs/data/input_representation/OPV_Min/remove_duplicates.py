...
DATA_DIR = pkg_resources.resource_filename(
    "ml_for_opvs", "data/input_representation/OPV_Min/master_ml_for_opvs_from_min_for_plotting.csv"
)
...
AUG_SMI_MASTER_DATA = pkg_resources.resource_filename(
    "ml_for_opvs", "data/input_representation/OPV_Min/augmentation/train_aug_master5.csv"
)
