...
class PC:
    ...
    def analysis(self):
        ...
        df_full = self.data.drop(columns = ['Unnamed: 0','Donor','Donor_SMILES','Donor_Big_SMILES','Donor_SELFIES','Acceptor','Acceptor_SMILES','Acceptor_Big_SMILES','Acceptor_SELFIES','solvent','solvent_additive','hole_contact_layer','electron_contact_layer','calc_PCE_percent','Jsc_mA_cm_pow_neg2','Voc_V','FF_percent','PCE_percent'])
