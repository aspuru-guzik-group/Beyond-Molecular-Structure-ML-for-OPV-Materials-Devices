...
gary_trained_results: Path = Path(__file__).parent.parent.parent / "gary" / "trained_results"
...
def transfer_results(gary_trained_results: Path, training_folder: Path):
    ...
    """
    input_reps: dict = {"fp": "fingerprint", "brics": "BRICS", "homolumo": "homo_lumo", "smiles": "smiles", 
                        "bigsmiles": "smiles", "selfies": "smiles", "ohe": "ohe", "graphembed": "graphembed",
                        "mordred": "mordred"}
    models: dict = {"gp": "GP", "ngboost": "NGBoost"}
    feature: dict = {"brics": "DA_tokenized_BRICS", "fp": "DA_FP_radius_3_nbits_1024", 
                     "gnn": "DA_gnn", "graphembed": "DA_graphembed", 
                     "homolumo": "HOMO_D_eV,LUMO_D_eV,HOMO_A_eV,LUMO_A_eV", 
                     "mordred": "DA_mordred", "ohe": "DA_ohe", "smiles": "DA_SMILES", 
                     "bigsmiles" :"DA_BigSMILES", "selfies": "DA_SELFIES"}
    target: dict = {}
    for file in gary_trained_results.iterdir():
        ...
        try:
            new_path: Path = new_path / input_reps[name_of_file_list[2]] / "result_molecules_only" / models[name_of_file_list[1]]
            new_path: Path = new_path / feature[name_of_file_list[2]] / "calc_PCE_percent"
