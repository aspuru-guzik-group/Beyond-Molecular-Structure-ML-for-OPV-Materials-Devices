...
DATA_DIR = pkg_resources.resource_filename(
    "ml_for_opvs", "data/process/master_ml_for_opvs_from_min.csv"
)
...
TRAIN_AUG_SMI_MASTER_DATA = pkg_resources.resource_filename(
    "ml_for_opvs", "data/augmentation/train_aug_master15.csv"
)

MANUAL_MASTER_DATA = pkg_resources.resource_filename(
    "ml_for_opvs", "data/manual_frag/master_manual_frag.csv"
)
