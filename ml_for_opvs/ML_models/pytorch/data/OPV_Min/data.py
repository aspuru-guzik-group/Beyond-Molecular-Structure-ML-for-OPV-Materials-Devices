...
class OPVDataset(Dataset):
    ...
    def get_splits_aug_old(self, aug_x, aug_y, seed_val):
        ...
        non_aug_size = len(self.x)
        train.dataset = OPVDataset(aug_x, aug_y)
        aug_train_idx = []
        for idx in train.indices:
            aug_train_idx.append(idx)
            aug_train_idx.append(idx + non_aug_size)
        train.indices = aug_train_idx
